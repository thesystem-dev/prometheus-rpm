...
This document describes how to build RPMs using mock and how artefacts are staged for signing and publishing.
...
> **Note:** This workflow uses a privileged Docker container to support mock's chroot operations.
> See the "Security Considerations" section at the end of this document for details.
...
This approach keeps mock compliant with its defaults (`$HOME/rpmbuild/results`) while ensuring artefacts appear immediately
...
Once RPMs are signed, create repository metadata and publish as described in [docs/publishing.md](publishing.md).
...
3. **Immediate availability** – Downstream scripts see fresh artefacts immediately
